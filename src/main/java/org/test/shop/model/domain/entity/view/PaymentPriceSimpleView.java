...
/**
 * PaymentPriceSimpleView generated by hbm2java, updated by voovee
 */
...
@Entity
@Table(name="payment_price_simple_view")
public class PaymentPriceSimpleView extends SView  {

	private static final long serialVersionUID = 3995475263636642L;
	...
	public PaymentPriceSimpleView() {
	}

	public PaymentPriceSimpleView(Integer id, String createdby,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PaymentPriceSimpleView))
			return false;
		PaymentPriceSimpleView castOther = (PaymentPriceSimpleView) other;
...
// ------------------ Logic part ------------------
	...
	public PaymentPriceSimpleView specialInit() {
	
		
		return this;
	}
	public PaymentPriceSimpleView init() {
		initList();
		initDicts();
	...
	public PaymentPriceSimpleView customInitList(List<String> list) {
		
		return this;
	}
	
	public PaymentPriceSimpleView initList() {

		return this;
	}
	
	public PaymentPriceSimpleView initDicts() {
		return this;
	}
