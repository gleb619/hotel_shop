...
/**
 * TmAccountView generated by hbm2java, updated by voovee
 */
...
@Entity
@Table(name="tm_account_view")
public class TmAccountView extends SView  {

	private static final long serialVersionUID = 6724822667927569L;
	...
	public TmAccountView() {
	}

	public TmAccountView(Integer id, Integer version, String createdby,
			Date createon, Integer firm, String lastmodifiedby, Date modifyon,
			String serieskey, String accountfullname, String accountname,
			String descr, Integer popularity, String locationcountries,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmAccountView))
			return false;
		TmAccountView castOther = (TmAccountView) other;
		...
		return ((this.getId() == castOther.getId()) || (this.getId() != null
				...
				&& ((this.getAccountfullname() == castOther
						.getAccountfullname()) || (this.getAccountfullname() != null
						&& castOther.getAccountfullname() != null && this
						.getAccountfullname().equals(
								castOther.getAccountfullname())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAccountfullname() == null ? 0 : this.getAccountfullname()
						.hashCode());
		result = 37
				* result
...
// ------------------ Logic part ------------------
	...
	public TmAccountView specialInit() {
	
		
		return this;
	}
	public TmAccountView init() {
		initList();
		initDicts();
	...
	public TmAccountView customInitList(List<String> list) {
	...
	public TmAccountView initList() {
		initLists(servTransfers);

		return this;
	}
	
	public TmAccountView initDicts() {
		return this;
	}
