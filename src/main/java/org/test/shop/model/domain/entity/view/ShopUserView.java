...
/**
 * ShopUserView generated by hbm2java, updated by voovee
 */
...
@Entity
@Table(name="shop_user_view")
public class ShopUserView extends SView  {

	private static final long serialVersionUID = 8281798596979287L;
	...
	private Integer shoppermission;
	private String label;

	public ShopUserView() {
	}

	public ShopUserView(Integer id, Integer version, String createdby,
			Date createon, Integer firm, String lastmodifiedby, Date modifyon,
			String serieskey, Boolean activated, String activationkey,
			String email, Boolean enabled, String firstname, String lastname,
			String password, String username, Integer image, String token,
			String phonenumber, Integer popularity, Integer shoppermission,
			String label) {
		this.id = id;
	...
	public Integer getShoppermission() {
		return this.shoppermission;
	}

	public void setShoppermission(Integer shoppermission) {
		this.shoppermission = shoppermission;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ShopUserView))
			return false;
		ShopUserView castOther = (ShopUserView) other;
...
// ------------------ Logic part ------------------
	...
	public ShopUserView specialInit() {
	
		
		return this;
	}
	public ShopUserView init() {
		initList();
		initDicts();
	...
	public ShopUserView customInitList(List<String> list) {
		
		return this;
	}
	
	public ShopUserView initList() {

		return this;
	}
	
	public ShopUserView initDicts() {
		return this;
	}
