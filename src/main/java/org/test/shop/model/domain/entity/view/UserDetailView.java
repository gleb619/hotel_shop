...
/**
 * UserDetailView generated by hbm2java, updated by voovee
 */
...
public class UserDetailView extends SView  {

	private static final long serialVersionUID = 4773543516121478L;
	...
	public UserDetailView(Integer id, Integer version, String companyname,
			String companysite, String createdby, Date createon, Integer firm,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UserDetailView))
			return false;
		UserDetailView castOther = (UserDetailView) other;
		...
		return ((this.getId() == castOther.getId()) || (this.getId() != null
				...
				&& ((this.getCompanysite() == castOther.getCompanysite()) || (this
						.getCompanysite() != null
						&& castOther.getCompanysite() != null && this
						.getCompanysite().equals(castOther.getCompanysite())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCompanysite() == null ? 0 : this.getCompanysite()
						.hashCode());
		result = 37 * result
...
// ------------------ Logic part ------------------
	...
	public UserDetailView specialInit() {
	
		
		return this;
	}
	public UserDetailView init() {
		initList();
		initDicts();
	...
	public UserDetailView customInitList(List<String> list) {
	...
	public UserDetailView initList() {
		initLists(relUserDetailses);

		return this;
	}
	
	public UserDetailView initDicts() {
		return this;
	}
