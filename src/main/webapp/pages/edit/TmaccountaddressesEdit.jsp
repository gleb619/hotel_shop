	...
	<div ng-if="!loading" class="edit-form-body">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				...
				<spring:message code="label.TmAccountAddresses" />
				<c:if test="${debug}">
					<span>{{ item.id }}</span>
					<a href="../data/tmaccountaddresses/{{ ::item.id }}?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
				</c:if>
				<!--
			  ...
			  <tab> 
				...
				<div class="col-md-6 col-lg-4 edit-block">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('locationcities', 'LocationCities', 'tmaccountaddresses', dataLocationCities)">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('locationcities', 'LocationCities', 'tmaccountaddresses', dataLocationCities)">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('tmaccount')">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('tmaccount', 'TmAccount', 'tmaccountaddresses', dataTmAccount)">
									<i class="fa fa-plus"></i>
								</button>
							</span>
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('tmaccount', 'TmAccount', 'tmaccountaddresses', dataTmAccount)">
									<i class="fa fa-search"></i>
								</button>
							</span>
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('zip')">
						...
						<input type="text" ng-model="item.zip" class="form-control" tabindex="5" />
					</div>

					<div class="form-group margin-top-5" ng-if="::checkVisibility('address')">
						<label><spring:message code="label.address" /></label>
						<input type="text" ng-model="item.address" class="form-control" tabindex="6" />
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-4 edit-block">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('addressname')">
						...
						<input type="text" ng-model="item.addressname" class="form-control" tabindex="7" />
					</div>
				</div>
