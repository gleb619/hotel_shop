	...
	<div ng-if="!loading" class="edit-form-body">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				...
				<spring:message code="label.RelServHotelDocDocuments" />
				<c:if test="${debug}">
					<span>{{ item.id }}</span>
					<a href="../data/relservhoteldocdocuments/{{ ::item.id }}?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
				</c:if>
				<!--
