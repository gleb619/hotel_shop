	...
	<div ng-if="!loading" class="edit-form-body">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				...
				<spring:message code="label.ReqServHotelRoomBusy" />
				<c:if test="${debug}">
					<span>{{ item.id }}</span>
					<a href="../data/reqservhotelroombusy/{{ ::item.id }}?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
				</c:if>
				<!--
				...
				<div class="col-sm-8 col-md-6 col-xs-offset-0 col-sm-offset-2 col-md-offset-3 edit-block">
						...
						<div class="picker-holder">
							<div class="col-xs-8">
								<div class="input-group picker-item">
									...
									<input type="text" class="form-control picker-input" ng-model="item.busystart" datepicker-popup="yyyy-MM-dd"
							...
							<div class="col-xs-4 auto-center">
								<timepicker ng-model="item.busystart" show-meridian="false" ng-change="convertDateAndTime(item.busystart, 'busystart')"></timepicker>
							</div>
						</div>
					</div>
						...
						<div class="picker-holder">
							<div class="col-xs-8">
								<div class="input-group picker-item">
									...
									<input type="text" class="form-control picker-input" ng-model="item.busyend" datepicker-popup="yyyy-MM-dd"
							...
							<div class="col-xs-4 auto-center">
								<timepicker ng-model="item.busyend" show-meridian="false" ng-change="convertDateAndTime(item.busyend, 'busyend')"></timepicker>
							</div>
						</div>
					</div>
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('servhotelroom', 'ServHotelRoom', 'reqservhotelroombusy', dataServHotelRoom)">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('servhotelroom', 'ServHotelRoom', 'reqservhotelroombusy', dataServHotelRoom)">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('dictglobal')">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('dictglobal', 'DictGlobal', 'reqservhotelroombusy', dataDictGlobal)">
									<i class="fa fa-plus"></i>
								</button>
							</span>
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('dictglobal', 'DictGlobal', 'reqservhotelroombusy', dataDictGlobal)">
									<i class="fa fa-search"></i>
								</button>
							</span>
