	...
	<div ng-if="!loading" class="edit-form-body">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				...
				<spring:message code="label.PaymentAccount" />
				<c:if test="${debug}">
					<span>{{ item.id }}</span>
					<a href="../data/paymentaccount/{{ ::item.id }}?initLists=true&initDicts=true" target="_blank" class="btn btn-default">
						JSON DATA
					</a>
				</c:if>
				<!--
		...
		<div class="modal-body padding-top-0">
			<tabset type="pills"> 
			  ...
			  <tab select="initTab('paymentaccountrecord', 'fragmentledit')">
						<tab-heading><spring:message code="label.PaymentAccountRecord"/></tab-heading>
						
						<div ng-if="templates.paymentaccountrecord.fragmentledit.init" ng-include="templates.paymentaccountrecord.fragmentledit.url"></div>
					</tab>
