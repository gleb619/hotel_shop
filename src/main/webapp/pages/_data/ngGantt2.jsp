<div class="gantt unselectable" ng-cloak gantt-scroll-manager
	...
	<script type="text/ng-template"
		id="template/ganttLabelsHeader.tmpl.html">
	...
	<script type="text/ng-template"
		id="template/ganttBodyBackground.tmpl.html">
                <div ng-transclude class="gantt-body-background"></div>
            </script>

	<!-- Row background template -->
	<script type="text/ng-template"
		id="template/ganttRowBackground.tmpl.html">
	...
	<script type="text/ng-template"
		id="template/ganttBodyForeground.tmpl.html">
                <div ng-transclude class="gantt-body-foreground"></div>
            </script>

	<!-- Body columns template -->
	<script type="text/ng-template"
		id="template/ganttBodyColumns.tmpl.html">
	...
	<script type="text/ng-template"
		id="template/ganttTaskContent.tmpl.html">
