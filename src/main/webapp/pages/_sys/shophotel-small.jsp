		...
		<div class="col-md-4 margin-top-5"
			...
			<div class="row margin-top-5">
				<div class="col-md-10">
					...
					<tab> <tab-heading> <spring:message code="label.descr" />
					</tab-heading>
					<div class="custom-textarea-holder scrollable-content-300 margin-bottom-10">
						<p ng-bind-html="item.descr"></p>
					</div>
					<footer>
						<a class="btn btn-default bottom-button" ng-disabled="modalOpening" ng-click="request(item.id)"
							role="button">
							<span>
					...
					<tab> <tab-heading> <spring:message code="label.characteristicsOf" /> </tab-heading>
				...
				<div class="col-md-2 center-content">
					<div ng-show="item.freesale" class="fa-stack fa-lg free-sale-holder" title="FreeSale">
						<i class="fa fa-circle	 fa-stack-2x free-sale-icon"></i>
						<span class="fa fa-lg fa-stack-1x fa-inverse free-sale-label">F</span>
					</div>
					<div ng-show="item.favorite" class="fa-stack fa-lg favorite-holder" title="Favorite">
