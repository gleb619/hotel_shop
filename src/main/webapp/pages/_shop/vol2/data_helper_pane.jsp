...
<div>
	<c:if test="${debug}">
		...
		<a role="button" class="btn btn-default btn-circle btn-lg" title="<spring:message code="default.random.request" />" scroll-to="#login">
			<i class="fa fa-random"></i>
		</a>
		</sec:authorize>
		<sec:authorize access="isAuthenticated()">
		<a role="button" class="btn btn-default btn-circle btn-lg" ng-click="openRequestPageDebug()" title="<spring:message code="default.random.request" />">
			<i class="fa fa-random"></i>
		</a>
		</sec:authorize>
	</c:if>
