...
<div class="row">
				<div class="col-md-6 col-lg-4 edit-block">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('locationcountries')">
						...
						<div class="input-group combobox-holder">
							...
							<select class="form-control"
									ng-model="item.locationcities.locationcountries"
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('nameeng')">
						...
						<input type="text" ng-model="item.locationcities.nameeng" class="form-control" tabindex="2" />
					</div>
					<div class="form-group margin-top-5" ng-if="::checkVisibility('cityname')">
						<label><spring:message code="label.cityname" /></label>
						<input type="text" ng-model="item.locationcities.cityname" class="form-control" tabindex="3" />
					</div>
				</div>
