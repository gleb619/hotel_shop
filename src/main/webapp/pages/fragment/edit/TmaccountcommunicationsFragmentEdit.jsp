...
<div class="row">
				<div class="col-md-6 col-lg-4 edit-block">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('label')">
						...
						<input type="text" ng-model="item.tmaccountcommunications.label" class="form-control" tabindex="1" />
					</div>
					<div class="form-group margin-top-5" ng-if="::checkVisibility('isdetail')">
						<input type="checkbox" ng-model="item.tmaccountcommunications.isDetail" tabindex="2"/>
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('locationcities')">
						...
						<div class="input-group combobox-holder">
							...
							<select class="form-control"
									ng-model="item.tmaccountcommunications.locationcities"
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('tmaccount')">
						...
						<div class="input-group combobox-holder">
							...
							<select class="form-control"
									ng-model="item.tmaccountcommunications.tmaccount"
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('dictglobal')">
						...
						<div class="input-group combobox-holder">
							...
							<select class="form-control"
									ng-model="item.tmaccountcommunications.dictglobal"
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('communicationname')">
						...
						<input type="text" ng-model="item.tmaccountcommunications.communicationname" class="form-control" tabindex="6" />
					</div>
				...
				<div class="col-md-6 col-lg-4 edit-block-2">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('communicationvalue')">
						...
						<input type="text" ng-model="item.tmaccountcommunications.communicationvalue" class="form-control" tabindex="7" />
					</div>
				</div>
