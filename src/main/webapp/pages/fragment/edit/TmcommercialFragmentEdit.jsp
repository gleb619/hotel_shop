...
<div class="row">
				<div class="col-md-6 col-lg-4 edit-block">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('label')">
						...
						<input type="text" ng-model="item.tmcommercial.label" class="form-control" tabindex="1" />
					</div>
					<div class="form-group margin-top-5" ng-if="::checkVisibility('dictglobal')">
						...
						<div class="input-group combobox-holder">
							...
							<select class="form-control"
									ng-model="item.tmcommercial.dictglobal"
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('name')">
						...
						<input type="text" ng-model="item.tmcommercial.name" class="form-control" tabindex="3" />
					</div>
				</div>
