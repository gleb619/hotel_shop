...
<div class="row">
				<div class="col-md-6 col-lg-4 edit-block">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('locationcountries')">
						...
						<div class="input-group combobox-holder">
							...
							<select class="form-control"
									ng-model="item.tmaccount.locationcountries"
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('accountname')">
						...
						<input type="text" ng-model="item.tmaccount.accountname" class="form-control" tabindex="2" />
					</div>
					<div class="form-group margin-top-5" ng-if="::checkVisibility('accountfullname')">
						...
						<input type="text" ng-model="item.tmaccount.accountfullname" class="form-control" tabindex="3" />
					</div>
				</div>
