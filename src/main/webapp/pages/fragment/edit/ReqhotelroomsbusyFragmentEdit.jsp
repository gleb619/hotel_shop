...
<div class="row">
				<div class="col-md-6 col-lg-4 edit-block">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('label')">
						...
						<input type="text" ng-model="item.reqhotelroomsbusy.label" class="form-control" tabindex="1" />
					</div>
						...
						<div class="picker-holder">
							<div class="col-xs-8">
								<div class="input-group picker-item">
									...
									<input type="text" class="form-control picker-input" ng-model="item.reqhotelroomsbusy.busystart" datepicker-popup="yyyy-MM-dd"
							...
							<div class="col-xs-4 auto-center">
								<timepicker ng-model="item.reqhotelroomsbusy.busystart" show-meridian="false" ng-change="convertDateAndTime(item.busystart, 'busystart')"></timepicker>
							</div>
						</div>
					</div>
						...
						<div class="picker-holder">
							<div class="col-xs-8">
								<div class="input-group picker-item">
									...
									<input type="text" class="form-control picker-input" ng-model="item.reqhotelroomsbusy.busyend" datepicker-popup="yyyy-MM-dd"
							...
							<div class="col-xs-4 auto-center">
								<timepicker ng-model="item.reqhotelroomsbusy.busyend" show-meridian="false" ng-change="convertDateAndTime(item.busyend, 'busyend')"></timepicker>
							</div>
						</div>
					</div>
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('servhotelroom')">
						...
						<div class="input-group combobox-holder">
							...
							<select class="form-control"
									ng-model="item.reqhotelroomsbusy.servhotelroom"
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('dictglobal')">
						...
						<div class="input-group combobox-holder">
							...
							<select class="form-control"
									ng-model="item.reqhotelroomsbusy.dictglobal"
