		...
		<div class="padding-left-right-15">
			<div class="btn-group without-padding display-block toolbar-panel">
				<button type="button" class="btn btn-default btn-edit padding-top-2-bottom-4 margin-left-0 col-xs-6 col-sm-6 col-md-6"
					ng-click="createModalItemRelServHotelImage()">
				...
				<button type="button" 
					...
					ng-click="pickItemRelServHotelImage()">
	...
	<div class="row gallery">
		<br>
	  	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 without-margin" 
	  		ng-repeat="item in item.relServHotelImages track by $index">
  			<a ng-click="deleteItemRelServHotelImage(item.id)" class="btn btn-default btn-delete boxclose">
