...
<div class="row">
	<div class="scrollable-content-300">
		<ol class="list-group">
			...
			<li class="list-group-item" ng-if="::checkVisibility('paymentcontact')">
				<span class="list-group-item-caption"><spring:message code="label.paymentContact" /></span>
				<span class="pull-right">{{ ::selectedItem.paymentcontact.label }}</span>
			</li>
