			...
			<div class="row">
				...
				<c:if test="${debug}">
					<div class="col-xs-2">
						...
						<a href="../data/relservhotelroomimage/{{ ::item.id }}" target="_blank" class="btn btn-default">
							JSON DATA
						</a>
					</div>
				</c:if>
		...
		<div class="row modal-body padding-top-0 selector-gallery">
			<br>
		  	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" 
		  		ng-repeat="item in dataTmImage track by $index | filter:searchKeywordRelServHotelRoomImage"
