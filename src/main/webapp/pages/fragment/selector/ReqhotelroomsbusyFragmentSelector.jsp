	...
	<div ng-if="!loading">
		<div class="modal-header">
			...
			<h4 class="modal-title">
				<spring:message code="default.listof" /> <spring:message code="label.ReqHotelRoomsBusy" />
			<h4>
		</div>
		...
		<c:if test="${debug}">
			<div class="row">
				<div class="margin-left-30">
					<a href="../data/reqhotelroomsbusyview?initLists=true&initDicts=true" target="_blank" class="btn btn-default">JSON DATA</a>
				</div>
			</div>
		</c:if>
			<div class="row">
			...
			<div class="col-md-12">
				<div class="table-responsive margin-bottom-5 table-body ledit-scroll scrollable-content-500"
					when-scrolled="loadDataReqHotelRoomsBusy()">
					<table class="table table-hover table-striped table-bordered margin-bottom-5 padding-all-2">
						...
						<tbody>
							<tr ng-repeat="item in filteredReqHotelRoomsBusy = ( dataReqHotelRoomsBusy | filter:searchKeywordReqHotelRoomsBusy ) track by $index"
				...
				<div class="btn-toolbar">
	  				<div class="btn-group">
						<button type="button" class="btn btn-default">
							...
							<span><spring:message code="default.total" />:{{ selectedItems.length }} / {{ filteredReqHotelRoomsBusy.length }} / {{ dataReqHotelRoomsBusy.length }}</span>
						</button>
						<button type="button" ng-disabled="scrollable.dataLoading" class="btn btn-primary" ng-click="loadDataReqHotelRoomsBusy()">
