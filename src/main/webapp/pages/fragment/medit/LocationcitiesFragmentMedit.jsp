	...
	<div ng-if="!loading" class="edit-form-body">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				<spring:message code="default.edit" /><spring:message code="label.LocationCities" />
			<c:if test="${debug}">
				<a href="../data/locationcities/{{ ::item.id }}" target="_blank" class="btn btn-default"> JSON DATA </a>
			</c:if>
			</h4>
		</div>
			...
			<div class="row">
				<div class="col-sm-8 col-md-6 col-xs-offset-0 col-sm-offset-2 col-md-offset-3 edit-block">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('locationcountries', 'LocationCountries', 'locationcities', dataLocationCountries)">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('locationcountries', 'LocationCountries', 'locationcities', dataLocationCountries)">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('nameeng')">
						...
						<input type="text" ng-model="item.nameeng" class="form-control" tabindex="2" />
					</div>

					<div class="form-group margin-top-5" ng-if="::checkVisibility('cityname')">
						<label><spring:message code="label.cityname" /></label>
						<input type="text" ng-model="item.cityname" class="form-control" tabindex="3" />
					</div>
				</div>
