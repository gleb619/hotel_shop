	...
	<div ng-if="!loading" class="edit-form-body">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				<spring:message code="default.edit" /><spring:message code="label.RelTmOrderServGifts" />
			<c:if test="${debug}">
				<a href="../data/reltmorderservgifts/{{ ::item.id }}" target="_blank" class="btn btn-default"> JSON DATA </a>
			</c:if>
			</h4>
		</div>
				...
				<div class="col-sm-8 col-md-6 col-xs-offset-0 col-sm-offset-2 col-md-offset-3 edit-block">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('tmorder', 'TmOrder', 'reltmorderservgifts', dataTmOrder)">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('tmorder', 'TmOrder', 'reltmorderservgifts', dataTmOrder)">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('servgifts')">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('servgifts', 'ServGifts', 'reltmorderservgifts', dataServGifts)">
									<i class="fa fa-plus"></i>
								</button>
							</span>
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('servgifts', 'ServGifts', 'reltmorderservgifts', dataServGifts)">
									<i class="fa fa-search"></i>
								</button>
							</span>
