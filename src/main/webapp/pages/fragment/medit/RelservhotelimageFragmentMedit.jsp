	...
	<div ng-if="!loading" class="edit-form-body">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				<spring:message code="default.edit" /><spring:message code="label.RelServHotelImage" />
			<c:if test="${debug}">
				<a href="../data/relservhotelimage/{{ ::item.id }}" target="_blank" class="btn btn-default"> JSON DATA </a>
			</c:if>
			</h4>
		</div>
				...
				<div class="col-sm-8 col-md-6 col-xs-offset-0 col-sm-offset-2 col-md-offset-3 edit-block">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('tmimage', 'TmImage', 'relservhotelimage', dataTmImage)">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('tmimage', 'TmImage', 'relservhotelimage', dataTmImage)">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('servhotel')">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('servhotel', 'ServHotel', 'relservhotelimage', dataServHotel)">
									<i class="fa fa-plus"></i>
								</button>
							</span>
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('servhotel', 'ServHotel', 'relservhotelimage', dataServHotel)">
									<i class="fa fa-search"></i>
								</button>
							</span>
