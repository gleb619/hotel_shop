	...
	<div ng-if="!loading" class="edit-form-body">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				<spring:message code="default.edit" /><spring:message code="label.ServInsurances" />
			<c:if test="${debug}">
				<a href="../data/servinsurances/{{ ::item.id }}" target="_blank" class="btn btn-default"> JSON DATA </a>
			</c:if>
			</h4>
		</div>
			...
			<div class="row">
				<div class="col-md-6 col-lg-4 edit-block">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('tmaccountbyaccount', 'TmAccount', 'servinsurances', dataTmAccountByAccountId)">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('tmaccountbyaccount', 'TmAccount', 'servinsurances', dataTmAccountByAccountId)">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('tmaccountbyinsaccount')">
						<label><spring:message code="label.tmAccountByInsAccountId" /></label>
						<div class="input-group combobox-holder">
							
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('tmaccountbyinsaccount', 'TmAccount', 'servinsurances', dataTmAccountByInsAccountId)">
									<i class="fa fa-plus"></i>
								</button>
							</span>
							
							<select class="form-control"
									ng-model="item.tmaccountbyinsaccount"
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('tmaccountbyinsaccount', 'TmAccount', 'servinsurances', dataTmAccountByInsAccountId)">
									<i class="fa fa-search"></i>
								</button>
							</span>
				...
				<div class="col-md-6 col-lg-4 edit-block">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('locationcountries')">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('locationcountries', 'LocationCountries', 'servinsurances', dataLocationCountries)">
									<i class="fa fa-plus"></i>
								</button>
							</span>
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('locationcountries', 'LocationCountries', 'servinsurances', dataLocationCountries)">
									<i class="fa fa-search"></i>
								</button>
							</span>
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('currcurrency')">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('currcurrency', 'CurrCurrency', 'servinsurances', dataCurrCurrency)">
									<i class="fa fa-plus"></i>
								</button>
							</span>
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('currcurrency', 'CurrCurrency', 'servinsurances', dataCurrCurrency)">
									<i class="fa fa-search"></i>
								</button>
							</span>
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('dictglobal')">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('dictglobal', 'DictGlobal', 'servinsurances', dataDictGlobal)">
									<i class="fa fa-plus"></i>
								</button>
							</span>
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('dictglobal', 'DictGlobal', 'servinsurances', dataDictGlobal)">
									<i class="fa fa-search"></i>
								</button>
							</span>
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('insurancename')">
						...
						<input type="text" ng-model="item.insurancename" class="form-control" tabindex="10" />
					</div>
				</div>
