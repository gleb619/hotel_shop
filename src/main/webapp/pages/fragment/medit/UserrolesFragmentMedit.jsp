	...
	<div ng-if="!loading" class="edit-form-body">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				<spring:message code="default.edit" /><spring:message code="label.UserRoles" />
			<c:if test="${debug}">
				<a href="../data/userroles/{{ ::item.id }}" target="_blank" class="btn btn-default"> JSON DATA </a>
			</c:if>
			</h4>
		</div>
			...
			<div class="row">
				<div class="col-sm-8 col-md-6 col-xs-offset-0 col-sm-offset-2 col-md-offset-3 edit-block">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('users', 'Users', 'userroles', dataUsers)">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('users', 'Users', 'userroles', dataUsers)">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('role')">
						...
						<input type="text" ng-model="item.role" class="form-control" tabindex="2" />
					</div>
				</div>
