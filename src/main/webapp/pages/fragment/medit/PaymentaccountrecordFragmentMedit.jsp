	...
	<div ng-if="!loading" class="edit-form-body">
		<div class="modal-header header">
			...
			<h4 class="modal-title">
				<spring:message code="default.edit" /><spring:message code="label.PaymentAccountRecord" />
			<c:if test="${debug}">
				<a href="../data/paymentaccountrecord/{{ ::item.id }}" target="_blank" class="btn btn-default"> JSON DATA </a>
			</c:if>
			</h4>
		</div>
				...
				<div class="col-md-6 col-lg-4 edit-block">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('currcurrencybypenaltycurrency', 'CurrCurrency', 'paymentaccountrecord', dataCurrCurrencyByPenaltyCurrencyId)">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('currcurrencybypenaltycurrency', 'CurrCurrency', 'paymentaccountrecord', dataCurrCurrencyByPenaltyCurrencyId)">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('currcurrencybyfinecurrency')">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('currcurrencybyfinecurrency', 'CurrCurrency', 'paymentaccountrecord', dataCurrCurrencyByFineCurrencyId)">
									<i class="fa fa-plus"></i>
								</button>
							</span>
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('currcurrencybyfinecurrency', 'CurrCurrency', 'paymentaccountrecord', dataCurrCurrencyByFineCurrencyId)">
									<i class="fa fa-search"></i>
								</button>
							</span>
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('currcurrencybymonthinstalcurrency')">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('currcurrencybymonthinstalcurrency', 'CurrCurrency', 'paymentaccountrecord', dataCurrCurrencyByMonthinstalCurrencyId)">
									<i class="fa fa-plus"></i>
								</button>
							</span>
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('currcurrencybymonthinstalcurrency', 'CurrCurrency', 'paymentaccountrecord', dataCurrCurrencyByMonthinstalCurrencyId)">
									<i class="fa fa-search"></i>
								</button>
							</span>
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('currcurrencybyresidualamountcurrency')">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('currcurrencybyresidualamountcurrency', 'CurrCurrency', 'paymentaccountrecord', dataCurrCurrencyByResidualAmountCurrencyId)">
									<i class="fa fa-plus"></i>
								</button>
							</span>
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('currcurrencybyresidualamountcurrency', 'CurrCurrency', 'paymentaccountrecord', dataCurrCurrencyByResidualAmountCurrencyId)">
									<i class="fa fa-search"></i>
								</button>
							</span>
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('paymentaccount')">
						<label><spring:message code="label.paymentAccount" /></label>
						<div class="input-group combobox-holder">
							
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('paymentaccount', 'PaymentAccount', 'paymentaccountrecord', dataPaymentAccount)">
									<i class="fa fa-plus"></i>
								</button>
							</span>
							
							<select class="form-control"
									ng-model="item.paymentaccount"
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('paymentaccount', 'PaymentAccount', 'paymentaccountrecord', dataPaymentAccount)">
									<i class="fa fa-search"></i>
								</button>
							</span>
				...
				<div class="col-md-6 col-lg-4 edit-block">
					...
					<div class="form-group margin-top-5" ng-if="::checkVisibility('currcurrencybyoverdueamountcurrency')">
						...
						<div class="input-group combobox-holder">
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-add" type="button"
									ng-click="addDict('currcurrencybyoverdueamountcurrency', 'CurrCurrency', 'paymentaccountrecord', dataCurrCurrencyByOverdueAmountCurrencyId)">
									<i class="fa fa-plus"></i>
								</button>
							</span>
							...
							<span class="input-group-btn">
								<button class="btn btn-default combobox-holder-search" type="button"
									ng-click="searchDict('currcurrencybyoverdueamountcurrency', 'CurrCurrency', 'paymentaccountrecord', dataCurrCurrencyByOverdueAmountCurrencyId)">
									<i class="fa fa-search"></i>
								</button>
							</span>
