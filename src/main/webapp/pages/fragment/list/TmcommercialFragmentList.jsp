			...
			<div class="col-md-12">
			  <div class="table-responsive">
				<table class="table table-hover table-striped table-bordered">
					...
					<tbody>
						<tr ng-repeat="item in selectedItem.tmCommercials track by $index">
				...
				<div>
					<spring:message code="default.total" />: {{ filteredTmCommercial.length }}/{{ selectedItem.tmCommercials.length }}
				</div>
			  </div>
		</div>
	</div>
