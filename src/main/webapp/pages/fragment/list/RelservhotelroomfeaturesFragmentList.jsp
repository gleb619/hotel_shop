			...
			<div class="col-md-12">
			  <div class="table-responsive">
				<table class="table table-hover table-striped table-bordered">
					...
					<tbody>
						<tr ng-repeat="item in selectedItem.relServHotelRoomFeatureses track by $index">
				...
				<div>
					<spring:message code="default.total" />: {{ filteredRelServHotelRoomFeatures.length }}/{{ selectedItem.relServHotelRoomFeatureses.length }}
				</div>
			  </div>
		</div>
	</div>
