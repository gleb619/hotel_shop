			...
			<div class="col-md-12">
			  <div class="table-responsive">
				<table class="table table-hover table-striped table-bordered">
					...
					<tbody>
						<tr ng-repeat="item in selectedItem.locationCountrieses track by $index">
				...
				<div>
					<spring:message code="default.total" />: {{ filteredLocationCountries.length }}/{{ selectedItem.locationCountrieses.length }}
				</div>
			  </div>
		</div>
	</div>
