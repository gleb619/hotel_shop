			...
			<div class="col-md-12">
			  <div class="table-responsive">
				<table class="table table-hover table-striped table-bordered">
					...
					<tbody>
						<tr ng-repeat="item in selectedItem.relServHotelEntertainmentAndSports track by $index">
				...
				<div>
					<spring:message code="default.total" />: {{ filteredRelServHotelEntertainmentAndSport.length }}/{{ selectedItem.relServHotelEntertainmentAndSports.length }}
				</div>
			  </div>
		</div>
	</div>
