			...
			<div class="col-md-12">
			  <div class="table-responsive">
				<table class="table table-hover table-striped table-bordered">
					...
					<tbody>
						<tr ng-repeat="item in selectedItem.paymentAccountRecords track by $index">
				...
				<div>
					<spring:message code="default.total" />: {{ filteredPaymentAccountRecord.length }}/{{ selectedItem.paymentAccountRecords.length }}
				</div>
			  </div>
		</div>
	</div>
